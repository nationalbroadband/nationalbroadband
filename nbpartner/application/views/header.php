...
<!-- -------------- CSS - theme -------------- -->
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>files/style/global/sidebar-menu/theme.css">
</head>
<!-- END HEAD -->
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			...
			<div id="sidebar_left_toggle" class="menu-toggler sidebar-toggler ad ad-lines">
			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<li class="<?php echo ($this->uri->segment(1)==='clients')?'active open':''?>">
					...
					<ul class="sub-menu">
                                ...
                                <li>
                                    <a href="<?php echo base_url(); ?>clients/expirylist"> Users Expiring</a>
                                </li>
                                <li>
...
<?php }; ?>
				...
				<li class="last <?php echo ($this->uri->segment(1)==='payments')?'active open':''?>">
					...
					<ul class="sub-menu">
                                ...
                                <li>
                                    <a href="<?php echo base_url(); ?>payments/addnew">Make User Payment</a>
                                </li>
					</ul>
				</li>
			</ul>
