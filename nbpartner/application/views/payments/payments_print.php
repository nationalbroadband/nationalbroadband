...
<body>
    ...
    <!-- Print CSS -->
    <link href="<?php echo base_url(); ?>style/css/print.css" rel="stylesheet" media="all" />
	
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo base_url(); ?>style/sb-admin-2/css/printbootstrap.min.css" rel="stylesheet" media="all" />
...
{ 
	...
	<div id="page-wrap">
			...
			<?php } else { ?>
						  <div class="row"><center> <h3>EBONE NETWORK (Pvt.) Ltd.</h3>
		...
		<div class="spacer"></div>
			...
			<?php } else { ?>
						  <div class="row">
						  <center> <h3>EBONE NETWORK (Pvt.) Ltd.</h3>
									<h4>Receiving Voucher</h4></center>
							<div class="col-xs-5 left">
								<div class="panel-heading">
									<h3>Dealer ID: <?php echo $post['customer']; ?></h3>
