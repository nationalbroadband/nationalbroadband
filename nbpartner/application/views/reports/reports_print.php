    ...
    <div id="wrapper">
			<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
                                    <thead>
										<tr><td align='center' colspan='9'><h1 style="font-size:20px; font-weight:400; color:#2a2f43";>Units Consumption by Users/Packages</h1></td></tr>
                                    </thead>
                                    <tbody>
								...
								<?php }?>
										<tr><td align="right" colspan="4">&nbsp;</td><td colspan="2">Total Units:: &nbsp;<?php echo $Total['DUAmount']; ?></td><td colspan="2">Total Tax: &nbsp;<?php echo $Total['TaxAmount']; ?></td></tr>
                                    </tbody>
                                </table>
							<?php //echo $pagelink;
								}?>
