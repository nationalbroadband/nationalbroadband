      ...
      echo form_open('reports/usersreports_print', $attributes);?>
									<div class="row">
										<div class="col-xs-4">
											<div class="input-group">
											<span class="input-group-addon">From Date</span>
												<input class="form-control form-control-inline input-medium date-picker" name="DateStart" type="text" value="" data-date-format="yyyy-mm-dd" data-date-start-date="-3m">
											</div>
										</div>
										<div class="col-xs-4">
											<div class="input-group">
                    ...
                    <!-- /.panel -->
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa"></i> Units Consumption Summary by Dealer-Package Wise 
      ...
      echo form_open('reports/index', $attributes);?>
									<div class="row">
										<div class="col-xs-4">
											<div class="input-group">
											<span class="input-group-addon">From Date</span>
												<input class="form-control form-control-inline input-medium date-picker" name="DateStart" type="text" value="" data-date-format="yyyy-mm-dd" data-date-start-date="-1y">
											</div>
										</div>
										<div class="col-xs-4">
											<div class="input-group">
											<span class="input-group-addon">To Date</span>
												<input class="form-control form-control-inline input-medium date-picker" name="DateEnd" type="text" value="" data-date-format="yyyy-mm-dd" data-date-start-date="-1y">
											</div>
										</div>
										<div class="col-xs-4">
											<div class="input-group">
