...
<!-- SIDEBAR MENU STYLES -->
<!-- -------------- CSS - theme -------------- -->
<link href="<?php echo base_url(); ?>files/style/admin/sidebar-menu/theme.css" rel="stylesheet" type="text/css"/>

<!-- -------------- jQuery -------------- -->
<script src="<?php echo base_url(); ?>files/style/admin/sidebar-menu/jquery-1.11.3.min.js"></script>
<script src="<?php echo base_url(); ?>files/style/admin/sidebar-menu/jquery-ui.min.js"></script>

<!-- -------------- Magnific Popup Plugin -------------- -->
<script src="<?php echo base_url(); ?>files/style/admin/sidebar-menu/jquery.magnific-popup.js"></script>

<!-- -------------- Theme Scripts -------------- -->
<script src="<?php echo base_url(); ?>files/style/admin/sidebar-menu/utility.js"></script>
<script src="<?php echo base_url(); ?>files/style/admin/sidebar-menu/demo.js"></script>
<script src="<?php echo base_url(); ?>files/style/admin/sidebar-menu/main.js"></script>

<!-- -------------- Widget JS -------------- -->
<script src="<?php echo base_url(); ?>files/style/admin/sidebar-menu/widgets.js"></script>
<script src="<?php echo base_url(); ?>files/style/admin/sidebar-menu/widgets_sidebar.js"></script>
<script src="<?php echo base_url(); ?>files/style/admin/sidebar-menu/dashboard1.js"></script>
<!-- -------------- /Scripts -------------- -->
</head>
<!-- END HEAD -->
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user">
						...
						<img alt="" class="img-circle" src="<?php echo base_url(); ?>files/images/avatar.jpg"/>
						</a>
