...
// UNITS REPORT ****** PRINT ******	 
	...
	function monthlybalancereport($date=0,$dealer=0) {
                $this->excel->setActiveSheetIndex(0);
                //name the worksheet
                $this->excel->getProperties()->setCreator("mohamadikhwan.com")
	...
	function download_to_excel($date="2015-09-09",$dealer="saqwas") {
                $this->excel->setActiveSheetIndex(0);
                //name the worksheet
                $this->excel->getActiveSheet()->setTitle('Testing');
                //set cell A1 content with some text

                $this->excel->getActiveSheet()->setCellValue('C1', ' Monthly Units Report');
                $this->excel->getActiveSheet()->setCellValue('C3', 'DealerID');
                $this->excel->getActiveSheet()->setCellValue('D3', 'Month');
                $this->excel->getActiveSheet()->setCellValue('E3', 'Bill Amount');
                $this->excel->getActiveSheet()->setCellValue('F3', 'Discount');
