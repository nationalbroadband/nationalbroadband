...
// SEND MAIL START				
	...
	$config = Array(
	   ...
	   $message = '<html>
				...
				<table>
					...
					<tr>
						<td>Free ID</td>
						<td>d'.strtolower($this->input->post('username')).'</td>
					</tr>
					<tr>
						<td>Dealer Name</td>
				...
				<p class="MsoNormal" style="mso-margin-top-alt: auto; margin-bottom: 12.0pt;"><strong><span style="font-size: 7.5pt; font-family: \'Calibri\',\'sans-serif\'; color: #1f497d; text-shadow: none;">Department</span></strong><strong><span style="font-size: 7.5pt; font-family: \'Arial\',\'sans-serif\'; color: gray; text-shadow: none;">│</span></strong><strong><span style="font-size: 7.5pt; font-family: \'Calibri\',\'sans-serif\'; color: #1f497d; text-shadow: none;">Company Name</span></strong><strong><span style="font-size: 7.5pt; font-family: \'Arial\',\'sans-serif\'; color: gray; text-shadow: none;">│</span></strong><span style="font-size: 11.0pt; font-family: \'Calibri\',\'sans-serif\'; text-shadow: none;"></span></p>
				...
				<strong><span style="font-size: 7.5pt; font-family: \'Arial\',\'sans-serif\'; color: #1f497d; text-shadow: none;">│</span></strong><a href="http://domain.com"><strong><span style="font-size: 7.5pt; font-family: \'Arial\',\'sans-serif\'; color: #104160; text-shadow: none;">www.sampledomain.com</span></strong></a><strong><span style="font-size: 7.5pt; font-family: \'Arial\',\'sans-serif\'; color: gray; text-shadow: none;">│</span></strong></div>
			</body>
		</html>';
 ...
 //   $this->load->library('email');
	$this->load->library('email', $config);
      ...
      // compose email
		$this->email->from('billingEmailaddress', 'Billing System');
		$this->email->to('supportemailaddress');
		$this->email->cc('ccaccountsemailaddress');
		$this->email->bcc('noemail');
