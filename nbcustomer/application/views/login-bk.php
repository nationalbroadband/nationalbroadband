...
<body>
    ...
    <div class="container">
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Please Sign In with your Dailer ID &amp; Password</h3>
                    </div>
                    <div class="panel-body">
						<?php if(!empty($loginerror)){?>
								<h1>Your ID or Password is incorrect.</h1>
						<?php }
      ...
      echo form_open('billpanel/login', $attributes);?>
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" name="username" placeholder="Type Dailer ID" name="text" type="text" autofocus>
                                </div>
                                <div class="form-group">
